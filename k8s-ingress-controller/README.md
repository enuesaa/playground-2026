...
- k3s で nginx と python3app の pod をそれぞれ立ててルーティングしてみる
  - k3s のデフォルトの ingress controller は traefik
  - だが他のやつに変えることもできるそう
- ingress-nginx は非推奨になったらしい
  - 別に Nginx Ingress Controller というのがあるのでそっちがよさそう？
